...
<head>
    ...
    <title>Recluse.OS | Dashboard</title>
...
<body class="bg-background text-zinc-300 font-sans min-h-screen flex flex-col selection:bg-primary selection:text-white">
    ...
    <nav class="glass-panel sticky top-0 z-50 px-6 py-4 flex justify-between items-center border-b border-white/5">
        <div class="flex items-center gap-3">
            ...
            <span class="text-xl font-bold text-white tracking-wide">RECLUSE<span class="font-light text-zinc-500">.OS</span></span>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2 cursor-pointer hover:bg-white/5 py-1.5 px-3 rounded-full transition border border-white/5">
                <img src="https://ui-avatars.com/api/?name=Ayush&background=8b5cf6&color=fff" alt="User" class="w-7 h-7 rounded-full">
                <span class="text-sm font-medium text-white">Ayush</span>
            </div>
        </div>
    </nav>
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto p-6 lg:p-8 flex flex-col gap-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
                <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-2">Welcome back, <span class="gradient-text">Ayush</span></h1>
                <p class="text-zinc-400">Manage your {bot_name} instance and monitor active modules across your servers.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="glass-panel p-5 rounded-2xl flex flex-col justify-between relative overflow-hidden group">
                ...
                <div>
                    <div class="text-3xl font-bold text-white mb-1">{server_count}</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 glass-panel rounded-2xl p-6 border border-primary/20 relative overflow-hidden">
                    ...
                    <p class="text-zinc-300 mb-8 max-w-2xl leading-relaxed">
                        The generative and conversational heart of Recluse. Currently processing contextual memory, dynamic image generation, and strict lexicon filtering across all servers.
                    </p>
